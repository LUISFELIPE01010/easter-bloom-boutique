  ...
  return (
    <form id={id} onSubmit={handleSubmit} className="w-full space-y-3">
      ...
      <motion.button
        ...
        type="submit"
        disabled={submitted}
        className={`w-full mt-2 py-3 sm:py-4 rounded-2xl font-display text-base sm:text-lg tracking-wide transition-all duration-500 shadow-[0_8px_25px_-8px_hsl(25_55%_25%/0.35)] hover:shadow-[0_12px_35px_-8px_hsl(25_55%_25%/0.45)] ${
          submitted
