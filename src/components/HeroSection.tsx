    ...
    <section className="relative min-h-screen flex items-start md:items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-16 md:pt-28 pb-8 md:pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="rounded-3xl p-8 backdrop-blur-sm border border-white/10 shadow-2xl" style={{ backgroundColor: 'rgba(236, 228, 210, 0.45)' }}>
              <div className="text-center mb-6">
                <h2 className="font-body text-2xl font-bold text-foreground">Garanta seu acesso VIP</h2>
